...
class _SearchDetailState extends State<SearchDetail> {
  ...
  Future<SearchResponseModel> getvehicledata(
            ...
            children: <Widget>[
              ...
              FutureBuilder(
                ...
                builder: (BuildContext ctx,
                    AsyncSnapshot<SearchResponseModel> snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    if (snapshot.hasError) {
                      ...
                      val1 = snapshot.data!.data!.vehicle!.majorAccident ==
                                  "yes" ||
                              snapshot.data!.data!.vehicle!.majorAccident ==
                                  "Yes"
                          ? 1
                          : 2;
                      val2 = snapshot.data!.data!.vehicle!.serviceHistory ==
                                  "yes" ||
                              snapshot.data!.data!.vehicle!.serviceHistory ==
                                  "Yes"
                          ? 1
                          : 2;
                      val3 = snapshot.data!.data!.vehicle!.vehicleType ==
                                  "private" ||
                              snapshot.data!.data!.vehicle!.majorAccident ==
                                  "Private"
                          ? 1
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                  ...
                                  child: Text(
                                    'Name of Brand : ${snapshot.data!.data!.vehicle!.brand!.name}',
                                    style:
                              ...
                              Container(
                                  ...
                                  child: Text(
                                    'Name of Vehicle : ${snapshot.data!.data!.vehicle!.vehicleName!.vehicleName}',
                                    style:
                                        Theme.of(context).textTheme.subtitle2,
                                  )),
                              const SizedBox(
                              ...
                              Container(
                                  ...
                                  child: Text(
                                    'Name of Variant : ${snapshot.data!.data!.vehicle!.variantId}',
                                    style:
                                        Theme.of(context).textTheme.subtitle2,
                                  )),
                              const SizedBox(
                              ...
                              Container(
                                  ...
                                  // child:Text('${Val!.fullName}',style: Theme.of(context).textTheme.caption,)
                                  child: Text(
                                    'Engine Number : ${snapshot.data!.data!.vehicle!.engineNo}',
                                    style:
                                        Theme.of(context).textTheme.subtitle2,
                                  )),
                              const SizedBox(
                              ...
                              Container(
                                  ...
                                  //child:Text('${Val!.fullName}',style: Theme.of(context).textTheme.caption,)
                                  child: Text(
                                    'Manufacture Year : ${snapshot.data!.data!.vehicle!.manufactureYear}',
                                    style:
                                        Theme.of(context).textTheme.subtitle2,
                                  )),
                              const SizedBox(
                              ...
                              Container(
                                  ...
                                  // child:Text('${Val!.fullName}',style: Theme.of(context).textTheme.caption,)
                                  child: Text(
                                    'Color : ${snapshot.data!.data!.vehicle!.color}',
                                    style:
                                        Theme.of(context).textTheme.subtitle2,
                                  )),
                              const SizedBox(
                              ...
                              Container(
                                  ...
                                  // child:Text('${Val!.fullName}',style: Theme.of(context).textTheme.caption,)
                                  child: Text(
                                    'No. of Seat : ${snapshot.data!.data!.vehicle!.noOfSeats}',
                                    style:
                                        Theme.of(context).textTheme.subtitle2,
                                  )),
                              const SizedBox(
                              ...
                              Container(
                                  ...
                                  // child:Text('${Val!.fullName}',style: Theme.of(context).textTheme.caption,)
                                  child: Text(
                                    'Purchase Year : ${snapshot.data!.data!.vehicle!.purchaseYear}',
                                    style:
                                        Theme.of(context).textTheme.subtitle2,
                                  )),
                              const SizedBox(
                              ...
                              Container(
                                  ...
                                  // child:Text('${Val!.fullName}',style: Theme.of(context).textTheme.caption,)
                                  child: Text(
                                    'No. of Transfers : ${snapshot.data!.data!.vehicle!.noOfTransfer}',
                                    style:
                                        Theme.of(context).textTheme.subtitle2,
                                  )),
                              const SizedBox(
                              ...
                              Container(
                                  ...
                                  child: Text(
                                    'Mileage : ${snapshot.data!.data!.vehicle!.kilometer}',
                                    style:
                                        Theme.of(context).textTheme.subtitle2,
                                  )),
                              const SizedBox(
                              ...
                              Container(
                                  ...
                                  child: Text(
                                    '${snapshot.data!.data!.vehicle!.vehicleNo}',
                                    style:
                                        Theme.of(context).textTheme.subtitle2,
                                  )),
                              SizedBox(
